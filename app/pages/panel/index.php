			...
			<div class="col-md-7" >
				<table class="table table-hover">
					<tr class="info">
					  ...
					  <!--<?php 
					  $re=Database::read("select name_schema,date_schema from Fiesta_schemas");

					  foreach ($re as $key => $value) {
					  	echo "<tr><td>".$value[0]."</td><td>".date("Y/m/d H:i:s",$value['date_schema'])."</td></tr>";
					  }
        ...
        <div class="tab-pane" id="links">
			...
			<div class="col-md-6">
				...
				<tr class="info">
				  ...
				  <?php foreach (glob("app/links/*.php") as $value) {
        ...
        <div class="tab-pane" id="seeds">
			...
			<div class="col-md-6">
				...
				<tr class="info">
				  ...
				  <?php foreach (glob("app/seeds/*.php") as $value) {
			  ...
			  <div class="panel-body">
			    ...
			    <div class="col-md-9">
					...
					<tr class="info">
					  ...
					  <?php foreach (glob("app/models/*.php") as $value) {
			  ...
			  <div class="panel-body">
				...
				<div class="col-md-9">
					...
					<tr class="info">
					  ...
					  <?php foreach (glob("app/views/*.php") as $value) {
			  ...
			  <div class="panel-body">
				...
				<div class="col-md-9">
					...
					<tr class="info">
					  ...
					  <?php foreach (glob("app/controllers/*.php") as $value) {
